defmodule ShortcutDemo.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # {ShortcutDemo.Worker, arg},
      # Start to serve requests, typically the last entry
      ShortcutDemoWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: ShortcutDemo.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ShortcutDemoWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
