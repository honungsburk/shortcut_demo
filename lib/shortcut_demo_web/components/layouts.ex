defmodule ShortcutDemoWeb.Layouts do
  @moduledoc """
    ...
    <header class="navbar px-4 sm:px-6 lg:px-8">
      <div class="flex-1">
        <a href="/" class="flex-1 flex w-fit items-center gap-2">
          <.icon name="hero-light-bulb" class="size-4 opacity-75 hover:opacity-100" />
          <span class="text-sm font-semibold">v{Application.spec(:shortcut_demo, :vsn)}</span>
        </a>
      </div>
      <div class="flex-none">
