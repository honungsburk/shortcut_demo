defmodule ShortcutDemoWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ShortcutDemoWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShortcutDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShortcutDemoWeb.Gettext, "errors", msg, opts)
    end
  end
